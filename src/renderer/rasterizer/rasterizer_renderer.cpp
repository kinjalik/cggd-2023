...
void cg::renderer::rasterization_renderer::render()
{
	...
	[](cg::vertex data, float z) {
		return cg::color{data.ambient_r,
						 data.ambient_g,
						 data.ambient_b,
		};
	};
	...
	std::cout << "Clear time: " << clear_duration.count() << " ms\n";
	...
	std::cout << "Rendering took " << 	std::chrono::duration<float, std::milli>(stop - start).count() << "ms\n";
